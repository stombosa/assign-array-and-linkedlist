...
describe("ArrayList", function () {
    ...
    describe ("contains", function() {
        let mylist = ["big", "small", "tall", "short", "round", "square", "enormous",
        ...
        it("finds the first element in the array", function () {
            let i = arrayList.contains("big", mylist);
            assert.equal(i, 0);
        });    
        it("finds the last element in the array", function () {
            let j = arrayList.contains("tiny", mylist);
            assert.equal(j, 12);
        });    
        it("finds a middle element in the array", function () {
            let h = arrayList.contains("hi", mylist);
            assert.equal(h, -1);
        });    
    });
});
